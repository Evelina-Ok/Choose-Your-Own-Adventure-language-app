...
) => `Let's create a "Choose Your Own Adventure" game to help people learn the ${language} with a language skill of ${readingAge}. Start the story with an engaging opening and provide 3 distinct options for me to choose from. 
